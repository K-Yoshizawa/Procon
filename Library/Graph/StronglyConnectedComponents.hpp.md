...
data:
  ...
  bundledCode: "#line 2 \"Library/Graph/Graph.hpp\"\n\n#line 2 \"Library/Common.hpp\"\
    ...
    \ RG(ReverseGraph(graph)), V(G.VertexSize()), belong_(V, -1){\n        vector<int>\
    ...
    \            if(!state[e.to]) continue;\n            dfs2(e.to, label, component,\
    \ state);\n        }\n        return;\n    }\n};\n"
  code: "#include \"Graph.hpp\"\n#include \"GraphMisc.hpp\"\n\ntemplate<typename WeightType>\n\
    struct StronglyConnectedComponents{\n    public:\n    StronglyConnectedComponents(Graph<WeightType>\
    \ &graph) :\n        G(graph), RG(ReverseGraph(graph)), V(G.VertexSize()), belong_(V,\
