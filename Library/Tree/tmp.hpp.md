...
data:
  ...
  bundledCode: "#line 2 \"Library/Tree/Tree.hpp\"\n\n#line 2 \"Library/Graph/Graph.hpp\"\
    ...
    \ int v : tree[u]){\n            if(v == p) continue;\n            ret[u] += self(self,\
    \ v, u);\n        }\n        return ret[u];\n    };\n    rec(rec, r, -1);\n  \
    \  return ret;\n}\n#line 2 \"Library/Tree/tmp.hpp\"\n\ntemplate<typename WeightType,\
    \ typename Group>\nclass RerootingDP{\n    public:\n    using FuncAddEdge = function<Group(Group)>;\n\
    \    using \n};\n"
  code: "#include \"Tree.hpp\"\n\ntemplate<typename WeightType, typename Group>\n\
    class RerootingDP{\n    public:\n    using FuncAddEdge = function<Group(Group)>;\n\
    \    using \n};"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: Library/Tree/tmp.hpp
layout: document
redirect_from:
- /library/Library/Tree/tmp.hpp
- /library/Library/Tree/tmp.hpp.html
