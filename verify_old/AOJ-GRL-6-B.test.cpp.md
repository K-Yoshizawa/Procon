...
data:
  ...
  bundledCode: "#line 1 \"verify_old/AOJ-GRL-6-B.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/5/GRL/6/GRL_6_B\"\
    \n\n#line 1 \"old/Graph/PrimalDual.hpp\"\n/**\n * @file PrimalDual.hpp\n * @author\
    ...
    \    }\n        }\n        return ret;\n    }\n};\n#line 4 \"verify_old/AOJ-GRL-6-B.test.cpp\"\
    \n\nint main(){\n    int V, E, F;\n    cin >> V >> E >> F;\n    Flow<int> G(V);\n\
    \    for(int i = 0; i < E; ++i){\n        Vertex u, v;\n        int c, d;\n  \
    \      cin >> u >> v >> c >> d;\n        G.add(u, v, c, d);\n    }\n\n    PrimalDual<int>\
  ...
  verifiedWith: []
documentation_of: verify_old/AOJ-GRL-6-B.test.cpp
layout: document
redirect_from:
- /verify/verify_old/AOJ-GRL-6-B.test.cpp
- /verify/verify_old/AOJ-GRL-6-B.test.cpp.html
