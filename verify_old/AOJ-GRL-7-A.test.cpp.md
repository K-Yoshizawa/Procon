...
data:
  ...
  bundledCode: "#line 1 \"verify_old/AOJ-GRL-7-A.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/5/GRL/7/GRL_7_A\"\
    ...
    \ > 0) ret += f;\n        }\n    }\n};\n#line 10 \"old/Graph/BipartiteMatching.hpp\"\
    ...
    \      return ML + __R - MR;\n    }\n};\n#line 4 \"verify_old/AOJ-GRL-7-A.test.cpp\"\
    \n\nint main(){\n    int X, Y, E;\n    cin >> X >> Y >> E;\n    BipartiteMatching\
    \ bm(X, Y);\n    for(int i = 0; i < E; ++i){\n        int x, y; cin >> x >> y;\n\
    \        bm.add(x, y);\n    }\n    cout << bm.solve() << endl;\n}\n"
  ...
  verifiedWith: []
documentation_of: verify_old/AOJ-GRL-7-A.test.cpp
layout: document
redirect_from:
- /verify/verify_old/AOJ-GRL-7-A.test.cpp
- /verify/verify_old/AOJ-GRL-7-A.test.cpp.html
