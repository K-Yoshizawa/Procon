...
data:
  ...
  bundledCode: "#line 1 \"verify_old/AOJ-GRL-6-A.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/5/GRL/6/GRL_6_A\"\
    \n\n#line 1 \"old/Graph/FordFulkerson.hpp\"\n/**\n * @file FordFulkerson.hpp\n\
    ...
    \            ans += F;\n        }\n        return ans;\n    }\n\n    vector<Edge<CostType>>\
    \ get(){\n        return G.get();\n    }\n};\n#line 4 \"verify_old/AOJ-GRL-6-A.test.cpp\"\
    \n\nint main(){\n    int V, E;\n    cin >> V >> E;\n    Flow<int> G(V);\n    for(int\
    \ i = 0; i < E; ++i){\n        int u, v, c;\n        cin >> u >> v >> c;\n   \
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/5/GRL/6/GRL_6_A\"\
    \n\n#include \"../old/Graph/FordFulkerson.hpp\"\n\nint main(){\n    int V, E;\n\
    \    cin >> V >> E;\n    Flow<int> G(V);\n    for(int i = 0; i < E; ++i){\n  \
    \      int u, v, c;\n        cin >> u >> v >> c;\n        G.add(u, v, c);\n  \
    \  }\n\n    // G.print_incidentlist(false);\n    // cerr << \"Check\" << endl;\n\
  ...
  verifiedWith: []
documentation_of: verify_old/AOJ-GRL-6-A.test.cpp
layout: document
redirect_from:
- /verify/verify_old/AOJ-GRL-6-A.test.cpp
- /verify/verify_old/AOJ-GRL-6-A.test.cpp.html
