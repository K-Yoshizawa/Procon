...
data:
  ...
  bundledCode: "#line 1 \"verify_old/AOJ-GRL-5-C.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/5/GRL/5/GRL_5_C\"\
    \n\n#line 1 \"old/Tree/LowestCommonAncestor.hpp\"\n/**\n * @file LowestCommonAncestor.hpp\n\
    ...
    \ }\n            cout << endl;\n        }\n    }\n};\n#line 10 \"old/Tree/LowestCommonAncestor.hpp\"\
    ...
    \ != __Parent[k][v]){\n                u = __Parent[k][u];\n                v\
    \ = __Parent[k][v];\n            }\n        }\n        return __Parent[0][u];\n\
    \    }\n};\n#line 4 \"verify_old/AOJ-GRL-5-C.test.cpp\"\n\nint main(){\n    int\
    \ n; cin >> n;\n    Graph<int> G(n);\n    for(int i = 0; i <= n - 1; ++i){\n \
    \       int k; cin >> k;\n        for(int j = 0; j < k; ++j){\n            int\
  ...
  verifiedWith: []
documentation_of: verify_old/AOJ-GRL-5-C.test.cpp
layout: document
redirect_from:
- /verify/verify_old/AOJ-GRL-5-C.test.cpp
- /verify/verify_old/AOJ-GRL-5-C.test.cpp.html
