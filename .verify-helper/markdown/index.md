...
data:
  ...
  - name: ADT_0318
    ...
    - icon: ':warning:'
      path: ADT_0318/A.cpp
      title: ADT_0318/A.cpp
    - icon: ':warning:'
      path: ADT_0318/B.cpp
      title: ADT_0318/B.cpp
    - icon: ':warning:'
      path: ADT_0318/C.cpp
      title: ADT_0318/C.cpp
    - icon: ':warning:'
      path: ADT_0318/D.cpp
      title: ADT_0318/D.cpp
    - icon: ':warning:'
      path: ADT_0318/E.cpp
      title: ADT_0318/E.cpp
    - icon: ':warning:'
      path: ADT_0318/F.cpp
      title: ADT_0318/F.cpp
    - icon: ':warning:'
      path: ADT_0318/G.cpp
      title: ADT_0318/G.cpp
    - icon: ':warning:'
      path: ADT_0318/H.cpp
      title: ADT_0318/H.cpp
    - icon: ':warning:'
      path: ADT_0318/I.cpp
      title: ADT_0318/I.cpp
  - name: Library
    pages:
