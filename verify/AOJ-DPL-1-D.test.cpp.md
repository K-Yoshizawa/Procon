...
data:
  ...
  bundledCode: "#line 1 \"verify/AOJ-DPL-1-D.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/7/DPL/1/DPL_1_D\"\
    ...
    \ _2, _3, _4, _5, ...) _5\n#define rep1(loop_count) for(int i = 0; i < (loop_count);\
    \ ++i)\n#define rep2(loop_var, loop_count) for(int (loop_var) = 0; (loop_var)\
    \ < (loop_count); ++(loop_var))\n#define rep3(loop_var, loop_init, loop_count)\
    \ for(int (loop_var) = (loop_init); (loop_var) < (loop_count); ++(loop_var))\n\
