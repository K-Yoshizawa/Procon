...
data:
  ...
  bundledCode: "#line 1 \"verify/LC-StaricRMQ.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/staticrmq\"\
    ...
    \   int N;\n};\n#line 5 \"verify/LC-StaricRMQ.test.cpp\"\n\nint main(){\n    cin.tie(0)->sync_with_stdio(false);\n\
    \    int N, Q; cin >> N >> Q;\n    vector<int> a(N);\n    for(int i = 0; i < N;\
  ...
  verifiedWith: []
documentation_of: verify/LC-StaricRMQ.test.cpp
layout: document
redirect_from:
- /verify/verify/LC-StaricRMQ.test.cpp
- /verify/verify/LC-StaricRMQ.test.cpp.html
