...
data:
  ...
  bundledCode: "#line 1 \"verify/AOJ-GRL-1-B-Dijkstra.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/5/GRL/1/GRL_1_B\"\n\n#include\
    ...
    \ - \u5358\u4E00\u59CB\u70B9\u6700\u77ED\u8DDD\u96E2\n * @version 2.1\n * @date\
    \ 2023-10-02\n */\n\n#line 10 \"library/Graph/BellmanFord.hpp\"\n\ntemplate<typename\
    ...
    \ + e.cost;\n                update = true;\n            }\n        }\n      \
    \  if(!update) break;\n        ++updatecount;\n    }\n    return ret;\n}\n#line\
    \ 7 \"verify/AOJ-GRL-1-B-Dijkstra.test.cpp\"\n\nusing namespace std;\n\nint main(){\n\
    \    int V, E, r;\n    cin >> V >> E >> r;\n    Graph<int> G(V, true);\n    for(int\
    \ i = 0; i < E; ++i){\n        int s, t, d;\n        cin >> s >> t >> d;\n   \
  ...
  verifiedWith: []
documentation_of: verify/AOJ-GRL-1-B-Dijkstra.test.cpp
layout: document
redirect_from:
- /verify/verify/AOJ-GRL-1-B-Dijkstra.test.cpp
- /verify/verify/AOJ-GRL-1-B-Dijkstra.test.cpp.html
