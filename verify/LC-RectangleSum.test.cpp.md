...
data:
  ...
  bundledCode: "#line 1 \"verify/LC-RectangleSum.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/rectangle_sum\"\
    ...
    \ T>\nclass Compress{\n    public:\n    Compress(vector<T> &A, bool unique_flag\
    \ = true) : data_(A){\n        sort(data_.begin(), data_.end());\n        if(unique_flag)\
    \ data_.erase(unique(data_.begin(), data_.end()), data_.end());\n        n_ =\
    \ (int)data_.size();\n    }\n\n    int Index(const T x) const {\n        int ret\
    \ = distance(data_.begin(), lower_bound(data_.begin(), data_.end(), x));\n   \
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/rectangle_sum\"\n\n#include\
    ...
    \ w] = DisassembleVectorTuple(points);\n    Compress cp(x, false);\n    MergeSortTree<ll>\
    \ mst(y, w, true);\n    while(Q--){\n        ll l, d, r, u; cin >> l >> d >> r\
    \ >> u;\n        int li = cp.LowerBound(l), ri = cp.LowerBound(r);\n        cout\
    \ << mst.SumBetween(li, ri, d, u - 1) << '\\n';\n    }\n}"
  dependsOn:
  - Library/Template.hpp
  - Library/Common.hpp
  ...
  requiredBy: []
  timestamp: '2026-02-12 16:51:38+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/LC-RectangleSum.test.cpp
layout: document
redirect_from:
- /verify/verify/LC-RectangleSum.test.cpp
- /verify/verify/LC-RectangleSum.test.cpp.html
