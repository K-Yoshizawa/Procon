...
data:
  ...
  bundledCode: "#line 1 \"verify/AOJ/AOJ-DSL-1-A.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/1/DSL_1_A\"\
    ...
    \     }), end(ret));\n        return ret;\n    }\n};\n#line 6 \"verify/AOJ/AOJ-DSL-1-A.test.cpp\"\
    \n\nusing namespace std;\n\nint main(){\n    int n, q;\n    cin >> n >> q;\n\n\
    \    UnionFind uf(n);\n    while(q--){\n        int com, x, y;\n        cin >>\
  ...
  verifiedWith: []
documentation_of: verify/AOJ/AOJ-DSL-1-A.test.cpp
layout: document
redirect_from:
- /verify/verify/AOJ/AOJ-DSL-1-A.test.cpp
- /verify/verify/AOJ/AOJ-DSL-1-A.test.cpp.html
