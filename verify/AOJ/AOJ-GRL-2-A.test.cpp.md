...
data:
  ...
  bundledCode: "#line 1 \"verify/AOJ/AOJ-GRL-2-A.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/5/GRL/2/GRL_2_A\"\
    ...
    \            }\n        }\n    }\n};\n#line 6 \"verify/AOJ/AOJ-GRL-2-A.test.cpp\"\
    \n\nusing namespace std;\n\nint main(){\n    int V, E;\n    cin >> V >> E;\n \
    \   Graph<int> G(V);\n    for(int i = 0; i < E; ++i){\n        int s, t, w;\n\
    \        cin >> s >> t >> w;\n        G.add(s, t, w);\n    }\n\n    Kruskal<int>\
    \ kr(G);\n    cout << kr.Cost << endl;\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/AOJ/AOJ-GRL-2-A.test.cpp
layout: document
redirect_from:
- /verify/verify/AOJ/AOJ-GRL-2-A.test.cpp
- /verify/verify/AOJ/AOJ-GRL-2-A.test.cpp.html
