...
data:
  ...
  bundledCode: "#line 1 \"verify_latest/LC-PointSetRangeComposite.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/point_set_range_composite\"\n\n#line\
    ...
    \ >;\nusing vvm107 = vector< vector< modint107 > >;\n#line 5 \"verify_latest/LC-PointSetRangeComposite.test.cpp\"\
    \n\nstruct Data{\n    modint998 a, b;\n\n    Data() : a(1), b(0){}\n    Data(int\
  ...
  verifiedWith: []
documentation_of: verify_latest/LC-PointSetRangeComposite.test.cpp
layout: document
redirect_from:
- /verify/verify_latest/LC-PointSetRangeComposite.test.cpp
- /verify/verify_latest/LC-PointSetRangeComposite.test.cpp.html
