...
data:
  ...
  bundledCode: "#line 1 \"verify_latest/LC-RangeAffineRangeSum.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/range_affine_range_sum\"\n\n#line\
    ...
    \ >;\nusing vvm107 = vector< vector< modint107 > >;\n#line 5 \"verify_latest/LC-RangeAffineRangeSum.test.cpp\"\
    \n\nstruct Data{\n    modint998 val;\n    int len;\n\n    Data() : val(0), len(1){}\n\
  ...
  verifiedWith: []
documentation_of: verify_latest/LC-RangeAffineRangeSum.test.cpp
layout: document
redirect_from:
- /verify/verify_latest/LC-RangeAffineRangeSum.test.cpp
- /verify/verify_latest/LC-RangeAffineRangeSum.test.cpp.html
