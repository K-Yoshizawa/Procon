...
data:
  ...
  bundledCode: "#line 1 \"verify_latest/AOJ-DSL-2-G.test.cpp\"\n#define PROBLEM \"\
    https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_G\"\n\n#line 1\
    ...
    };\n#line 4 \"verify_latest/AOJ-DSL-2-G.test.cpp\"\n\nstruct Data{\n    long long\
    \ val{0};\n    long long len{1};\n\n    Data() : val(0), len(1){}\n    Data(int\
  ...
  verifiedWith: []
documentation_of: verify_latest/AOJ-DSL-2-G.test.cpp
layout: document
redirect_from:
- /verify/verify_latest/AOJ-DSL-2-G.test.cpp
- /verify/verify_latest/AOJ-DSL-2-G.test.cpp.html
