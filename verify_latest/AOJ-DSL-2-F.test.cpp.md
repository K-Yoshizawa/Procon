...
data:
  ...
  bundledCode: "#line 1 \"verify_latest/AOJ-DSL-2-F.test.cpp\"\n#define PROBLEM \"\
    https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_F\"\n\n#line 1\
    ...
    };\n#line 4 \"verify_latest/AOJ-DSL-2-F.test.cpp\"\n\nint main(){\n    int n,\
  ...
  verifiedWith: []
documentation_of: verify_latest/AOJ-DSL-2-F.test.cpp
layout: document
redirect_from:
- /verify/verify_latest/AOJ-DSL-2-F.test.cpp
- /verify/verify_latest/AOJ-DSL-2-F.test.cpp.html
